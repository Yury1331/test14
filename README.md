...
Каталог оборудования и расчёты коммерческих предложений по видеонаблюдению.

## Структура

```
test14/
├── cameras/          # Каталоги по моделям
├── dialogs/          # Сводки запросов
├── kp/               # Коммерческие предложения и расчёты
└── templates/        # Шаблоны запросов КП
```
